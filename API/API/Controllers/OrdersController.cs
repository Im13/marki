...
namespace API.Controllers
{
    public class OrdersController : BaseApiController
    {
        ...
        public OrdersController(IOrderService orderService, IExcelExportInterface excelExportInterface, IMapper mapper, IGenericRepository<Order> orderRepo, IOrderRepository orderRepository, INotificationService notificationService)
        {
            _mapper = mapper;
        ...
        public async Task<ActionResult<Order>> CreateOrder(OrderDTO orderDTO)
        {
            try
            {
                ...
                await _notificationService.CreateNotificationForAdminsAsync(email, order.Id.ToString());
