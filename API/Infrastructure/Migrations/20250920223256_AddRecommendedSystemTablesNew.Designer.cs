...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250920223256_AddRecommendedSystemTablesNew")]
    partial class AddRecommendedSystemTablesNew
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.RecommendedData.ProductFeatures", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("CategorySimilarity")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Core.Entities.RecommendedData.Recommendation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Entities.RecommendedData.User", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Entities.RecommendedData.UserInteraction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Entities.RecommendedData.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Core.Entities.RecommendedData.ProductFeatures", b =>
                {
                    b.HasOne("Core.Entities.Product", "Product")
                        .WithOne("Features")
                        .HasForeignKey("Core.Entities.RecommendedData.ProductFeatures", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Core.Entities.RecommendedData.Recommendation", b =>
                {
                    ...
                    b.HasOne("Core.Entities.RecommendedData.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.RecommendedData.UserProfile", b =>
                {
                    b.HasOne("Core.Entities.RecommendedData.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("Core.Entities.RecommendedData.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
